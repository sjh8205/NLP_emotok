...
class MultiClassDataLoader(object):
    ...
    def define_flags(self):
        self.__flags.DEFINE_string("train_data_file", "./data/0116train", "Data source for the training data.")
        #self.__flags.DEFINE_string("dev_data_file", "./data/dev", "Data source for the cross validation data.")
        self.__flags.DEFINE_string("class_data_file", "./data/class", "Data source for the class list.")
        self.__flags.DEFINE_string("dev_data_file", "오늘 뭐해", "Data source for the cross validation data.")
    
    def load_dev_data_and_labels(self):
        self.__resolve_params()
        x_dev = self.__load_data_and_labels(self.__dev_data_file)
        print(x_dev)
        return x_dev
    ...
    def __load_data_and_labels(self, data):
        x_text = []
        y = []
        ...
        data = self.__data_processor.clean_data(data)
        x_text.append(data)
...
'''
    def prepare_data(self):
        ...
        x_dev, y_dev = self.__load_data_andp_labels(self.__dev_data_file)
